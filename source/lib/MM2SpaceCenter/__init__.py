...
class MM2SpaceCenter:
    ...
    def wordsForMMPair(self):
        ...
        # read wordlist file
        with open(self.wordlistPath, mode="r", encoding="utf-8") as fo:
...
def run(wordlistPath_rel):
    ...
    libFolder = os.path.abspath(pathname)
    baseFolder = os.path.dirname(libFolder)
    wordlistPath_abs = os.path.join(baseFolder, wordlistPath_rel)
    # print(wordlistPath_abs)
